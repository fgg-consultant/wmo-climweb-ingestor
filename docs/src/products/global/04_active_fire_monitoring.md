...
![WMS Layer](/wms/msg_fes_fire.png)
...
- [Learn More](https://data.eumetsat.int/product/EO:EUM:DAT:MSG:FIR): The active fire monitoring product is a fire detection product indicating the presence of fire within a pixel.
